...
import com.test_6200.testdb322.service.Table2Service;
import java.io.*;
 ...
 */
@RestController(value = "Testdb322.Table2Controller")
@RequestMapping("/testdb322/Table2")
...
public class Table2Controller {
    ...
    @Autowired
    @Qualifier("testdb322.Table2Service")
    ...
    public Table2 getTable2(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
