...
@Service
public class Testdb322QueryExecutorServiceImpl implements Testdb322QueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(Testdb322QueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("testdb322WMQueryExecutor")
